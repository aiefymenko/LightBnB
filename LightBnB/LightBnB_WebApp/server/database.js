...
const getAllProperties = function (options, limit = 10) {
  ...
  if (options.city) {
    ...
    queryString += `AND city ILIKE $${queryParams.length} `; //insensitive to case
  }
  if (options.owner_id) {
...
const addProperty = function (property) {
  return pool
    .query(
      ...
      [property.owner_id, property.title, property.description, property.thumbnail_photo_url, property.cover_photo_url, property.cost_per_night*100,
      property.street, property.city, property.province, property.post_code, property.country, property.parking_spaces || 0,
